...
public class DataInit {
    ...
    public static void main(String[] args) {
        ...
        initBaseItemRecommend();//初始化所有用户基于物品的推荐
     ...
     */
    public static void initDefaultRecomend() {
...
//        productList = productList.subList(20, 40);  //截取20个商品作为默认推荐商品列表
     ...
     */
    @Test
    public static void initBaseItemRecommend() {
        ShardedJedis jedis = MyShardedJedisPool.getResource();
        List<Product> productList = JDProduct.getProduct();
//        productList = productList.subList(10, 30);
     ...
     */
    @Test
    public static void initBaseUserRecommend() {
        ShardedJedis jedis = MyShardedJedisPool.getResource();
        List<Product> productList = JDProduct.getProduct();
//        productList = productList.subList(0, 20);
     ...
     */
    @Test
    public  static void initBaseItemResult() {
        ShardedJedis jedis = MyShardedJedisPool.getResource();
        List<Product> productList = JDProduct.getProduct();
     ...
     */
    @Test
    public static void initBaseContentResult() {
        ShardedJedis jedis = MyShardedJedisPool.getResource();
        List<Product> productList = JDProduct.getProduct();
        int num = productList.size();
        for (int i = 0; i < num; i++) {
